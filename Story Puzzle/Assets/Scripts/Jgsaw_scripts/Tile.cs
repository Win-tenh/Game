...
public class Tile
{
    ...
    // for an img of size 140 by 140 it will start at 20,20
    ...
    // pixel is visited. need this array for flood fill
    ...
    public Tile(Texture2D texture)
    {
        ...
        // we now initialse the newly created texture with transparent color
    ...
    public static LineRenderer CreateLineRederer(UnityEngine.Color color, float lineWidth = 1.0f)
    {
    ...
    public void DrawCurve(Direction dir, PosNegType type, UnityEngine.Color color)
    {
        ...
        {
            mLineRenderers.Add((dir, type), CreateLineRederer(color));
        }
